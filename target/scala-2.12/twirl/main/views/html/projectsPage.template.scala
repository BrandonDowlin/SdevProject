...
<div class="row">
  ...
  """),format.raw/*68.3*/("""<div class="col-sm-2">
    ...
    <div class="list-group">
      <a href=""""),_display_(/*71.17*/routes/*71.23*/.HomeController.addEmployee()),format.raw/*71.52*/("""" class="list-group-item">
        <span class="">Add an Employee</span>
      </a>
      <a href=""""),_display_(/*74.17*/routes/*74.23*/.HomeController.addDepartment()),format.raw/*74.54*/("""" class="list-group-item">
          <span class="">Add a Department</span>
        </a>
        <a href=""""),_display_(/*77.19*/routes/*77.25*/.HomeController.addProject()),format.raw/*77.53*/("""" class="list-group-item">
            <span class="">Add a Project</span>
          </a>
          <a href=""""),_display_(/*80.21*/routes/*80.27*/.HomeController.addUser()),format.raw/*80.52*/("""" class="list-group-item">
