      ...
      <tbody>
        """),_display_(/*39.10*/for(p<-employees) yield /*39.27*/ {_display_(Seq[Any](format.raw/*39.29*/("""
          """),format.raw/*40.11*/("""<tr>
            ...
            """),_display_(/*51.14*/if(user != null)/*51.30*/{_display_(Seq[Any](format.raw/*51.31*/("""
            """),_display_(/*52.14*/if(user.getRole().equals("admin"))/*52.48*/{_display_(Seq[Any](format.raw/*52.49*/("""

            
            """),format.raw/*55.13*/("""<td>
                
              <a href=""""),_display_(/*57.25*/routes/*57.31*/.HomeController.updateEmployee(p.getId)),format.raw/*57.70*/("""" class="button xs btn-danger">
                    <span class="glyphicon glyphicon-pencil"></span>
                  
                
              </a>
            </td>        <td>
              <a href=""""),_display_(/*63.25*/routes/*63.31*/.HomeController.deleteEmployee(p.getId)),format.raw/*63.70*/("""" class="button xs btn-danger" onclick="return confirmDel();">
        ...
        """)))}),format.raw/*68.10*/("""
          """),format.raw/*69.11*/("""</tr>
        """)))}),format.raw/*70.10*/("""
      """),format.raw/*71.7*/("""</tbody>

    </table>

    <p>
      <a href=""""),_display_(/*76.17*/routes/*76.23*/.HomeController.addEmployee()),format.raw/*76.52*/("""">
